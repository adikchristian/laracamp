                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.discount.store') }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea rows="2" class="form-control" name="description" placeholder="Description">{{ old('description') }}</textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number"
                                        ...
                                        placeholder="Percentange" value="{{ old('precentage') }}" min="1" max="100">
